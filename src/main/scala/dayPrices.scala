...
object dayPrices {
	...
	def main(args: Array[String]) {
		...
		val spark = SparkSession.builder.appName("Let-s-Vacation").getOrCreate()
		...
		// Select only the price_items that we will be using, and drop the rest including null values
		val selectedColumns = citiesDF.select("name","currency", "1", "2", "3", "4", "6", "7", "9", "18", "19", "107", "108", "110", "113", "116").na.drop()
        
		// Create an RDD out of the selectedColumns dataframe
